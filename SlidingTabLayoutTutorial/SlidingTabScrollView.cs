...
namespace SlidingTabLayoutTutorial
{
    public class SlidingTabScrollView : HorizontalScrollView
    {
        ...
        public ViewPager ViewPager
        {
            set
            {
                ...
                if (value != null)
                {
                    ...
                    PopulateTabStrip();
                    mViewPager.SetCurrentItem(mViewPager.Adapter.Count, true);
                }
            }
        }
        ...
        void value_PageSelected(object sender, ViewPager.PageSelectedEventArgs e)
        {
            ...
            if (mViewPagerPageChangeListener != null)
            {
                mViewPagerPageChangeListener.OnPageSelected(5);
            }
        }
        ...
        private void PopulateTabStrip()
        {
            ...
            for (int i = adapter.Count -1; i >=0; i--)
            {
                ...
                tabView.Gravity = GravityFlags.Center;
                ...
                tabView.Tag = (((SlidingTabsFragment.SamplePagerAdapter)adapter).Count - 1) - i;                
